...
class Bild
{
    ...
    public function getHTML($userStatus)
    {
        ...
        echo '<input type="text" class="form-control" name="name'.$this->bid.'" id="name'.$this->bid.'" value="'.$this->name.'">';
        echo '</div>';
        echo '</div>';
        echo '<div class="col">';
        echo '<!-- Bildowner -->';
        ...
        echo '<input type="text" class="form-control" name="owner'.$this->bid.'" id="owner'.$this->bid.'" value="'.$zusatzInfos["ownerName"].'">';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '<div class="row">';
        ...
        echo '<input type="text" class="form-control" name="uploadDatum'.$this->bid.'" id="uploadDatum'.$this->bid.'" value="'.$this->uploadDatum.'">';
        echo '</div>';
        echo '</div>';
        echo '<div class="col">';
        echo '<!-- Aufnahmedatum -->';
        ...
        echo '<input type="text" class="form-control" name="aufnahmeDatum'.$this->bid.'" id="aufnahmeDatum'.$this->bid.'" value="'.$this->aufnahmeDatum.'">';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '<div class="row">';
        ...
        echo '<input type="text" class="form-control" name="latitude'.$this->bid.'" id="latitude'.$this->bid.'" value="'.$this->latitude.'">';
        echo '</div>';
        echo '</div>';
        echo '<div class="col-sm-3">';
        echo '<!-- Longitude -->';
        ...
        echo '<input type="text" class="form-control" name="longitude'.$this->bid.'" id="longitude'.$this->bid.'" value="'.$this->longitude.'">';
        echo '</div>';
        echo '</div>';
        ...
        echo '<input class="form-check-input" type="checkbox" value="" id="isPublic'.$this->bid.'">';
        ...
        echo '<a href="#" class="btn-sm btn-danger">Bild löschen</a>';
        echo '</div>';
        echo '</div>';
        echo '</form>';
        echo '<!-- Spacer -->';
        ...
        echo '<input type="text" class="form-control" placeholder="neuer Tag" aria-label="neuer Tag" aria-describedby="button-addon">';
        ...
        echo '<div class="input-group mb-3">';
        echo '<input type="text" class="form-control" placeholder="neue Freigabe" aria-label="neuer Tag" aria-describedby="button-addon">';
        echo '<div class="input-group-append">';
